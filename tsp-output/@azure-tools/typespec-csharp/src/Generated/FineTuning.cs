...
namespace OpenAI
{
    ...
    public partial class FineTuning
    {
        ...
        public virtual async Task<ClientResult<FineTuningJob>> CreateFineTuningJobAsync(CreateFineTuningJobRequest job, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateFineTuningJobAsync(content, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<FineTuningJob> CreateFineTuningJob(CreateFineTuningJobRequest job, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = job.ToBinaryBody();
            ClientResult result = CreateFineTuningJob(content, context);
            return ClientResult.FromValue(FineTuningJob.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual async Task<ClientResult> CreateFineTuningJobAsync(BinaryContent content, RequestOptions context = null)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ClientResult<ListPaginatedFineTuningJobsResponse>> GetPaginatedFineTuningJobsAsync(string after = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetPaginatedFineTuningJobsAsync(after, limit, context).ConfigureAwait(false);
        ...
        /// <param name="limit"> Number of fine-tuning jobs to retrieve. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ClientResult<ListPaginatedFineTuningJobsResponse> GetPaginatedFineTuningJobs(string after = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetPaginatedFineTuningJobs(after, limit, context);
            return ClientResult.FromValue(ListPaginatedFineTuningJobsResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetPaginatedFineTuningJobsAsync(string after, int? limit, RequestOptions context)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetPaginatedFineTuningJobs(string after, int? limit, RequestOptions context)
        {
            using PipelineMessage message = CreateGetPaginatedFineTuningJobsRequest(after, limit, context);
            return ClientResult.FromResponse(_pipeline.ProcessMessage(message, context));
        }
        ...
        public virtual async Task<ClientResult<FineTuningJob>> RetrieveFineTuningJobAsync(string fineTuningJobId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await RetrieveFineTuningJobAsync(fineTuningJobId, context).ConfigureAwait(false);
            return ClientResult.FromValue(FineTuningJob.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<FineTuningJob> RetrieveFineTuningJob(string fineTuningJobId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = RetrieveFineTuningJob(fineTuningJobId, context);
            return ClientResult.FromValue(FineTuningJob.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> RetrieveFineTuningJobAsync(string fineTuningJobId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(fineTuningJobId, nameof(fineTuningJobId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult RetrieveFineTuningJob(string fineTuningJobId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(fineTuningJobId, nameof(fineTuningJobId));
        ...
        public virtual async Task<ClientResult<FineTuningJob>> CancelFineTuningJobAsync(string fineTuningJobId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await CancelFineTuningJobAsync(fineTuningJobId, context).ConfigureAwait(false);
            return ClientResult.FromValue(FineTuningJob.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<FineTuningJob> CancelFineTuningJob(string fineTuningJobId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = CancelFineTuningJob(fineTuningJobId, context);
            return ClientResult.FromValue(FineTuningJob.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> CancelFineTuningJobAsync(string fineTuningJobId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(fineTuningJobId, nameof(fineTuningJobId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult CancelFineTuningJob(string fineTuningJobId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(fineTuningJobId, nameof(fineTuningJobId));
        ...
        public virtual async Task<ClientResult<ListFineTuningJobEventsResponse>> GetFineTuningEventsAsync(string fineTuningJobId, string after = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetFineTuningEventsAsync(fineTuningJobId, after, limit, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<ListFineTuningJobEventsResponse> GetFineTuningEvents(string fineTuningJobId, string after = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetFineTuningEvents(fineTuningJobId, after, limit, context);
            return ClientResult.FromValue(ListFineTuningJobEventsResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetFineTuningEventsAsync(string fineTuningJobId, string after, int? limit, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(fineTuningJobId, nameof(fineTuningJobId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetFineTuningEvents(string fineTuningJobId, string after, int? limit, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(fineTuningJobId, nameof(fineTuningJobId));
        ...
        internal PipelineMessage CreateCreateFineTuningJobRequest(BinaryContent content, RequestOptions context)
        {
