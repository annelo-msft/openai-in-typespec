...
namespace OpenAI
{
    ...
    public partial class Moderations
    {
        ...
        public virtual async Task<ClientResult<CreateModerationResponse>> CreateModerationAsync(CreateModerationRequest content, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateModerationAsync(content0, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<CreateModerationResponse> CreateModeration(CreateModerationRequest content, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content0 = content.ToBinaryBody();
            ClientResult result = CreateModeration(content0, context);
            return ClientResult.FromValue(CreateModerationResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual async Task<ClientResult> CreateModerationAsync(BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult CreateModeration(BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal PipelineMessage CreateCreateModerationRequest(BinaryContent content, RequestOptions context)
        {
