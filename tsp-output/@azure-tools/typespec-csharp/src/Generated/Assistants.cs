...
namespace OpenAI
{
    ...
    public partial class Assistants
    {
        ...
        public virtual async Task<ClientResult<AssistantObject>> CreateAssistantAsync(CreateAssistantRequest assistant, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateAssistantAsync(content, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<AssistantObject> CreateAssistant(CreateAssistantRequest assistant, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = assistant.ToBinaryBody();
            ClientResult result = CreateAssistant(content, context);
            return ClientResult.FromValue(AssistantObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual async Task<ClientResult> CreateAssistantAsync(BinaryContent content, RequestOptions context = null)
        {
        ...
        {
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetAssistantsAsync(limit, order?.ToString(), after, before, context).ConfigureAwait(false);
        ...
        {
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetAssistants(limit, order?.ToString(), after, before, context);
            return ClientResult.FromValue(ListAssistantsResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetAssistantsAsync(int? limit, string order, string after, string before, RequestOptions context)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetAssistants(int? limit, string order, string after, string before, RequestOptions context)
        {
            using PipelineMessage message = CreateGetAssistantsRequest(limit, order, after, before, context);
            return ClientResult.FromResponse(_pipeline.ProcessMessage(message, context));
        }
        ...
        public virtual async Task<ClientResult<AssistantObject>> GetAssistantAsync(string assistantId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetAssistantAsync(assistantId, context).ConfigureAwait(false);
            return ClientResult.FromValue(AssistantObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<AssistantObject> GetAssistant(string assistantId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetAssistant(assistantId, context);
            return ClientResult.FromValue(AssistantObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetAssistantAsync(string assistantId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
        ...
        public virtual async Task<ClientResult<AssistantObject>> ModifyAssistantAsync(string assistantId, ModifyAssistantRequest assistant, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = assistant.ToBinaryBody();
            ClientResult result = await ModifyAssistantAsync(assistantId, content, context).ConfigureAwait(false);
            return ClientResult.FromValue(AssistantObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<AssistantObject> ModifyAssistant(string assistantId, ModifyAssistantRequest assistant, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = assistant.ToBinaryBody();
            ClientResult result = ModifyAssistant(assistantId, content, context);
            return ClientResult.FromValue(AssistantObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> ModifyAssistantAsync(string assistantId, BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<ClientResult<DeleteAssistantResponse>> DeleteAssistantAsync(string assistantId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await DeleteAssistantAsync(assistantId, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<DeleteAssistantResponse> DeleteAssistant(string assistantId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = DeleteAssistant(assistantId, context);
            return ClientResult.FromValue(DeleteAssistantResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> DeleteAssistantAsync(string assistantId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
        ...
        public virtual async Task<ClientResult<AssistantFileObject>> CreateAssistantFileAsync(string assistantId, CreateAssistantFileRequest file, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateAssistantFileAsync(assistantId, content, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<AssistantFileObject> CreateAssistantFile(string assistantId, CreateAssistantFileRequest file, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = file.ToBinaryBody();
            ClientResult result = CreateAssistantFile(assistantId, content, context);
            return ClientResult.FromValue(AssistantFileObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> CreateAssistantFileAsync(string assistantId, BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult CreateAssistantFile(string assistantId, BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<ClientResult<ListAssistantFilesResponse>> GetAssistantFilesAsync(string assistantId, int? limit = null, ListOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetAssistantFilesAsync(assistantId, limit, order?.ToString(), after, before, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<ListAssistantFilesResponse> GetAssistantFiles(string assistantId, int? limit = null, ListOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetAssistantFiles(assistantId, limit, order?.ToString(), after, before, context);
            return ClientResult.FromValue(ListAssistantFilesResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetAssistantFilesAsync(string assistantId, int? limit, string order, string after, string before, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetAssistantFiles(string assistantId, int? limit, string order, string after, string before, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
        ...
        public virtual async Task<ClientResult<AssistantFileObject>> GetAssistantFileAsync(string assistantId, string fileId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetAssistantFileAsync(assistantId, fileId, context).ConfigureAwait(false);
            return ClientResult.FromValue(AssistantFileObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<AssistantFileObject> GetAssistantFile(string assistantId, string fileId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetAssistantFile(assistantId, fileId, context);
            return ClientResult.FromValue(AssistantFileObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetAssistantFileAsync(string assistantId, string fileId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetAssistantFile(string assistantId, string fileId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
        ...
        public virtual async Task<ClientResult<DeleteAssistantFileResponse>> DeleteAssistantFileAsync(string assistantId, string fileId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await DeleteAssistantFileAsync(assistantId, fileId, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<DeleteAssistantFileResponse> DeleteAssistantFile(string assistantId, string fileId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = DeleteAssistantFile(assistantId, fileId, context);
            return ClientResult.FromValue(DeleteAssistantFileResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> DeleteAssistantFileAsync(string assistantId, string fileId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult DeleteAssistantFile(string assistantId, string fileId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(assistantId, nameof(assistantId));
            Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
        ...
        internal PipelineMessage CreateCreateAssistantRequest(BinaryContent content, RequestOptions context)
        {
        ...
        internal PipelineMessage CreateModifyAssistantRequest(string assistantId, BinaryContent content, RequestOptions context)
        {
            var message = _pipeline.CreateMessage();
            if (context != null)
            {
        ...
        internal PipelineMessage CreateCreateAssistantFileRequest(string assistantId, BinaryContent content, RequestOptions context)
        {
            var message = _pipeline.CreateMessage();
            if (context != null)
            {
