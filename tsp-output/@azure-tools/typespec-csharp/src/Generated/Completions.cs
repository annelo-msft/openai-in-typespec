...
namespace OpenAI
{
    ...
    public partial class Completions
    {
        ...
        public virtual async Task<ClientResult<CreateCompletionResponse>> CreateCompletionAsync(CreateCompletionRequest createCompletionRequest, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateCompletionAsync(content, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="createCompletionRequest"/> is null. </exception>
        public virtual ClientResult<CreateCompletionResponse> CreateCompletion(CreateCompletionRequest createCompletionRequest, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(createCompletionRequest, nameof(createCompletionRequest));

            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = createCompletionRequest.ToBinaryBody();
            ClientResult result = CreateCompletion(content, context);
            return ClientResult.FromValue(CreateCompletionResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual async Task<ClientResult> CreateCompletionAsync(BinaryContent content, RequestOptions context = null)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult CreateCompletion(BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal PipelineMessage CreateCreateCompletionRequest(BinaryContent content, RequestOptions context)
        {
