...
namespace OpenAI
{
    ...
    public partial class Embeddings
    {
        ...
        public virtual async Task<ClientResult<CreateEmbeddingResponse>> CreateEmbeddingAsync(CreateEmbeddingRequest embedding, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateEmbeddingAsync(content, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<CreateEmbeddingResponse> CreateEmbedding(CreateEmbeddingRequest embedding, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = embedding.ToBinaryBody();
            ClientResult result = CreateEmbedding(content, context);
            return ClientResult.FromValue(CreateEmbeddingResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual async Task<ClientResult> CreateEmbeddingAsync(BinaryContent content, RequestOptions context = null)
        {
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult CreateEmbedding(BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal PipelineMessage CreateCreateEmbeddingRequest(BinaryContent content, RequestOptions context)
        {
