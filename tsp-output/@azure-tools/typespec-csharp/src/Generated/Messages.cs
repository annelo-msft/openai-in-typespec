...
namespace OpenAI
{
    ...
    public partial class Messages
    {
        ...
        public virtual async Task<ClientResult<MessageObject>> CreateMessageAsync(string threadId, CreateMessageRequest message, CancellationToken cancellationToken = default)
        {
            ...
            ClientResult result = await CreateMessageAsync(threadId, content, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<MessageObject> CreateMessage(string threadId, CreateMessageRequest message, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = message.ToBinaryBody();
            ClientResult result = CreateMessage(threadId, content, context);
            return ClientResult.FromValue(MessageObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual async Task<ClientResult> CreateMessageAsync(string threadId, BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        public virtual async Task<ClientResult<ListMessagesResponse>> GetMessagesAsync(string threadId, int? limit = null, ListOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetMessagesAsync(threadId, limit, order?.ToString(), after, before, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<ListMessagesResponse> GetMessages(string threadId, int? limit = null, ListOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetMessages(threadId, limit, order?.ToString(), after, before, context);
            return ClientResult.FromValue(ListMessagesResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetMessagesAsync(string threadId, int? limit, string order, string after, string before, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetMessages(string threadId, int? limit, string order, string after, string before, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        public virtual async Task<ClientResult<MessageObject>> GetMessageAsync(string threadId, string messageId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetMessageAsync(threadId, messageId, context).ConfigureAwait(false);
            return ClientResult.FromValue(MessageObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<MessageObject> GetMessage(string threadId, string messageId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetMessage(threadId, messageId, context);
            return ClientResult.FromValue(MessageObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetMessageAsync(string threadId, string messageId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
        ...
        public virtual async Task<ClientResult<MessageObject>> ModifyMessageAsync(string threadId, string messageId, ModifyMessageRequest message, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = message.ToBinaryBody();
            ClientResult result = await ModifyMessageAsync(threadId, messageId, content, context).ConfigureAwait(false);
            return ClientResult.FromValue(MessageObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        public virtual ClientResult<MessageObject> ModifyMessage(string threadId, string messageId, ModifyMessageRequest message, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using BinaryContent content = message.ToBinaryBody();
            ClientResult result = ModifyMessage(threadId, messageId, content, context);
            return ClientResult.FromValue(MessageObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> ModifyMessageAsync(string threadId, string messageId, BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult ModifyMessage(string threadId, string messageId, BinaryContent content, RequestOptions context = null)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<ClientResult<ListMessageFilesResponse>> GetMessageFilesAsync(string threadId, string messageId, int? limit = null, ListOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetMessageFilesAsync(threadId, messageId, limit, order?.ToString(), after, before, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<ListMessageFilesResponse> GetMessageFiles(string threadId, string messageId, int? limit = null, ListOrder? order = null, string after = null, string before = null, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetMessageFiles(threadId, messageId, limit, order?.ToString(), after, before, context);
            return ClientResult.FromValue(ListMessageFilesResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetMessageFilesAsync(string threadId, string messageId, int? limit, string order, string after, string before, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetMessageFiles(string threadId, string messageId, int? limit, string order, string after, string before, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
        ...
        public virtual async Task<ClientResult<MessageFileObject>> GetMessageFileAsync(string threadId, string messageId, string fileId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = await GetMessageFileAsync(threadId, messageId, fileId, context).ConfigureAwait(false);
        ...
        public virtual ClientResult<MessageFileObject> GetMessageFile(string threadId, string messageId, string fileId, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            ClientResult result = GetMessageFile(threadId, messageId, fileId, context);
            return ClientResult.FromValue(MessageFileObject.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetMessageFileAsync(string threadId, string messageId, string fileId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetMessageFile(string threadId, string messageId, string fileId, RequestOptions context)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
            Argument.AssertNotNullOrEmpty(messageId, nameof(messageId));
            Argument.AssertNotNullOrEmpty(fileId, nameof(fileId));
        ...
        internal PipelineMessage CreateCreateMessageRequest(string threadId, BinaryContent content, RequestOptions context)
        {
        ...
        internal PipelineMessage CreateModifyMessageRequest(string threadId, string messageId, BinaryContent content, RequestOptions context)
        {
            var message = _pipeline.CreateMessage();
            if (context != null)
            {
