...
{
    public partial class CreateTranslationResponse : IUtf8JsonSerializable, IJsonModel<CreateTranslationResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateTranslationResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CreateTranslationResponse DeserializeCreateTranslationResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string text = default;
            Optional<CreateTranslationResponseTask> task = default;
            ...
            return new CreateTranslationResponse(text, Optional.ToNullable(task), language.Value, Optional.ToNullable(duration), Optional.ToList(segments), serializedAdditionalRawData);
        }
        ...
        internal static CreateTranslationResponse FromResponse(Response response)
        {
