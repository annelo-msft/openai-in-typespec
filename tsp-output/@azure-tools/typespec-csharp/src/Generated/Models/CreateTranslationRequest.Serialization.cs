...
{
    public partial class CreateTranslationRequest : IUtf8JsonSerializable, IJsonModel<CreateTranslationRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateTranslationRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CreateTranslationRequest DeserializeCreateTranslationRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<CreateTranslationRequestResponseFormat> responseFormat = default;
            ...
            return new CreateTranslationRequest(file, model, prompt.Value, Optional.ToNullable(responseFormat), Optional.ToNullable(temperature), serializedAdditionalRawData);
        }
        ...
        internal static CreateTranslationRequest FromResponse(Response response)
        {
