...
{
    public partial class AudioSegment : IUtf8JsonSerializable, IJsonModel<AudioSegment>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioSegment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AudioSegment FromResponse(Response response)
        {
