...
{
    public partial class CreateTranscriptionRequest : IUtf8JsonSerializable, IJsonModel<CreateTranscriptionRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateTranscriptionRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CreateTranscriptionRequest DeserializeCreateTranscriptionRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<CreateTranscriptionRequestResponseFormat> responseFormat = default;
            Optional<double> temperature = default;
            ...
            return new CreateTranscriptionRequest(file, model, language.Value, prompt.Value, Optional.ToNullable(responseFormat), Optional.ToNullable(temperature), serializedAdditionalRawData);
        }
        ...
        internal static CreateTranscriptionRequest FromResponse(Response response)
        {
